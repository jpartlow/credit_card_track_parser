...
This Javscript library is for parsing credit card track data such as might be returned from a USB card reader.
...
You may run the tests in using the Javascript interpreter of your browser by viewing test/tests.html in your browser.
